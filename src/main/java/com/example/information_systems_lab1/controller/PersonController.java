...
public class PersonController {
    ...
    @PatchMapping("/edit")
    public ResponseEntity<?> updatePerson(@RequestParam Long id, @Valid @RequestBody Person updatedPerson) throws InsufficientEditingRightsException, JsonProcessingException {
        try {
